...
{
    public partial class SpellManager : NetworkBehaviour
    {
        /// <summary>
        /// A scriptable object which contains all MOFA spell prefabs.
        /// </summary>
        ...
        private void Start()
        {
            ...
            if (!HoloKitApp.Instance.IsHost && HoloKitApp.Instance.IsPlayer)
            {
