...
public class FindMissingScriptsEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("Find missing scripts"))
        {
            ...
            string[] files = System.IO.Directory.GetFiles(Application.dataPath + "/../Packages" , "*.prefab", System.IO.SearchOption.AllDirectories);
            ...
            {
                string prefabPath = files[i].Replace(Application.dataPath + "/../Packages", "Packages");
